...
class Product extends Model
{
    ...
    public function scopeAvailableItems($query) //必ず名前にscopeをつける。引数は$queryとする
    {
        ...
        return $query
        ->joinSub($stocks, 'stock', function($join){ //joinSub(サブクエリ,サブクエリのテーブル名,表示する列情報)
        ...
        ,'image1.filename as filename'); //最後->get();はつけない
    }
}
